...
# Form implementation generated from reading ui file 'yearly_graph_window.ui'
#
...
class Ui_YearlyGraphMainWindow(object):
    def setupUi(self, YearlyGraphMainWindow):
        YearlyGraphMainWindow.setObjectName("YearlyGraphMainWindow")
        YearlyGraphMainWindow.resize(500, 600)
        YearlyGraphMainWindow.setMinimumSize(QtCore.QSize(500, 600))
        YearlyGraphMainWindow.setMaximumSize(QtCore.QSize(500, 600))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(self.resource_path("icons/sms_icon64x64.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        YearlyGraphMainWindow.setWindowIcon(icon)
        YearlyGraphMainWindow.setStyleSheet("")
        self.centralwidget = QtWidgets.QWidget(YearlyGraphMainWindow)
...
"}")
        ...
        YearlyGraphMainWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(YearlyGraphMainWindow)
        QtCore.QMetaObject.connectSlotsByName(YearlyGraphMainWindow)

    def retranslateUi(self, YearlyGraphMainWindow):
        _translate = QtCore.QCoreApplication.translate
        YearlyGraphMainWindow.setWindowTitle(_translate("YearlyGraphMainWindow", "Graph"))
        self.grossIncomeLabel.setText(_translate("YearlyGraphMainWindow", "GROSS INCOME"))
        item = self.graphDataTableWidget.horizontalHeaderItem(0)
        item.setText(_translate("YearlyGraphMainWindow", "YEAR"))
        item = self.graphDataTableWidget.horizontalHeaderItem(1)
        item.setText(_translate("YearlyGraphMainWindow", "INCOME (GH₵)"))
        self.viewGraphButton.setText(_translate("YearlyGraphMainWindow", "View"))
