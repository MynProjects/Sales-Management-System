...
# Form implementation generated from reading ui file 'monthly_graph_window.ui'
#
...
class Ui_MonthlyGraphMainWindow(object):
    def setupUi(self, MonthlyGraphMainWindow):
        MonthlyGraphMainWindow.setObjectName("MonthlyGraphMainWindow")
        MonthlyGraphMainWindow.resize(500, 600)
        MonthlyGraphMainWindow.setMinimumSize(QtCore.QSize(500, 600))
        MonthlyGraphMainWindow.setMaximumSize(QtCore.QSize(500, 600))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(self.resource_path("icons/sms_icon64x64.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        MonthlyGraphMainWindow.setWindowIcon(icon)
        MonthlyGraphMainWindow.setStyleSheet("")
        self.centralwidget = QtWidgets.QWidget(MonthlyGraphMainWindow)
...
"}")
        ...
        MonthlyGraphMainWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(MonthlyGraphMainWindow)
        QtCore.QMetaObject.connectSlotsByName(MonthlyGraphMainWindow)

    def retranslateUi(self, MonthlyGraphMainWindow):
        _translate = QtCore.QCoreApplication.translate
        MonthlyGraphMainWindow.setWindowTitle(_translate("MonthlyGraphMainWindow", "Graph"))
        self.grossIncomeLabel.setText(_translate("MonthlyGraphMainWindow", "GROSS INCOME"))
        item = self.graphDataTableWidget.horizontalHeaderItem(0)
        item.setText(_translate("MonthlyGraphMainWindow", "MONTHLY"))
        item = self.graphDataTableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MonthlyGraphMainWindow", "INCOME (GH₵)"))
        self.viewGraphButton.setText(_translate("MonthlyGraphMainWindow", "View"))
